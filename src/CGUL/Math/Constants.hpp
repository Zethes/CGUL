...
namespace CGUL
{
    ...
    namespace Math
    {
        /** @brief A namespace containing many common mathematical constants.
        *  @details Many mathematical constants were ruthlessly stolen from MathDotNet.  Be sure to
        *  check it out!  Also check out wikipedia's page of mathematical constants.
        *  http://numerics.mathdotnet.com/api/MathNet.Numerics/Constants.htm
