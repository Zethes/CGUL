...
namespace CGUL
{
    ...
    struct Vector3T
    {
        ...
        //! @brief Performs linear interpolation on a vector3      
        _CGUL_INLINE_DEFINE static Vector3T Lerp(const Vector3T& from, const Vector3T& to, Type t);
        ...
        _CGUL_INLINE_DEFINE operator Vector3T< OtherType >() const;
