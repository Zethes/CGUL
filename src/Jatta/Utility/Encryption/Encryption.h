...
namespace Jatta
{
	namespace Encryption
	{
		...
		namespace CRC32
		{
			_JATTA_EXPORT unsigned long Data( const void* data, unsigned int length, unsigned long seed);
			_JATTA_EXPORT unsigned long String(String in, unsigned long seed);

			_JATTA_EXPORT unsigned long Start(unsigned long seed);
