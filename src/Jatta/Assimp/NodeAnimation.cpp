...
_JATTA_EXPORT Jatta::Assimp::NodeAnimation::NodeAnimation(aiNodeAnim* animation)
{
...
{
	return (VectorKey*)nodeAnim->mPositionKeys;
}
...
{
	return (VectorKey*)nodeAnim->mScalingKeys;
}